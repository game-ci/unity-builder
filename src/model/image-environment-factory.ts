...
class ImageEnvironmentFactory {
  ...
  public static getEnvironmentVariables(parameters: BuildParameters) {
    const environmentVariables: Parameter[] = [
      ...
      { name: 'ANDROID_APP_BUNDLE', value: parameters.androidAppBundle ? 'true' : 'false' },
      { name: 'EXPORT_AS_GOOGLE_ANDROID_PROJECT', value: parameters.exportAsGoogleAndroidProject ? 'true' : 'false' },
